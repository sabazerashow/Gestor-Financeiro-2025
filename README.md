...
3. Run both the frontend and the AI server:
   `npm run dev:all`
   
   *Note: If you only want the frontend, use `npm run dev`. To use AI features like transaction analysis, both must be running.*
