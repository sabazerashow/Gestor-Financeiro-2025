    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        <div className="p-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Entenda Seu Bilhete de Pagamento</h2>
        ...
        <div className="p-6 overflow-y-auto prose prose-sm dark:prose-invert max-w-none">
          ...
          <h4 className="font-bold mt-6 mb-2 text-gray-800 dark:text-gray-200">Pagamentos (Créditos)</h4>
          ...
          <div className="space-y-4 text-gray-700 dark:text-gray-300">
            <div>
              ...
              <p className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1">É o valor-base fixo para o seu posto, estabelecido por lei. Ele serve como referência para os demais cálculos.</p>
            </div>
            <div>
              <strong>AD MILITAR (Adicional Militar)</strong>
              <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                ...
                <em className="block text-gray-500 dark:text-gray-400">(R$ 11.587,00 × 0,25 = R$ 2.896,75)</em>
              </div>
            </div>
            <div>
              <strong>AD COMP DISP (Adicional de Compensação por Disponibilidade)</strong>
               <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                    ...
                    <em className="block text-gray-500 dark:text-gray-400">(R$ 11.587,00 × 0,20 = R$ 2.317,40)</em>
               </div>
            </div>
            <div>
              ...
              <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                ...
                <em className="block text-gray-500 dark:text-gray-400">(R$ 11.587,00 × 0,73 = R$ 8.458,51)</em>
              </div>
            </div>
            <div>
          ...
          <h4 className="font-bold mt-6 mb-2 text-gray-800 dark:text-gray-200">Descontos (Débitos)</h4>
          <p>Estes são os valores deduzidos da sua remuneração bruta.</p>

          <div className="mt-4">
            <h5 className="font-semibold text-gray-800 dark:text-gray-200">1. Descontos Obrigatórios (Percentuais)</h5>
            ...
            <div className="space-y-4 mt-2 text-gray-700 dark:text-gray-300">
               <div>
                  ...
                  <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                    ...
                    <em className="block text-gray-500 dark:text-gray-400">(R$ 27.577,06 × 0,105 = R$ 2.895,59)</em>
                  </div>
              </div>
              <div>
                  ...
                  <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                    ...
                    <em className="block text-gray-500 dark:text-gray-400">(R$ 27.577,06 × 0,018 = R$ 496,38)</em>
                  </div>
              </div>
              <div>
                  ...
                  <div className="ml-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600 mt-1 space-y-1">
                    ...
                    <em className="block text-gray-500 dark:text-gray-400">(R$ 27.577,06 × 0,003 = R$ 82,73)</em>
                  </div>
              </div>
            </div>
          </div>
           ...
           <div className="mt-4">
                <h5 className="font-semibold text-gray-800 dark:text-gray-200">2. Outros Descontos (Consignações - Valor Fixo)</h5>
          ...
          <div className="mt-4">
            <h5 className="font-semibold text-gray-800 dark:text-gray-200">3. Imposto de Renda (Cálculo Complexo)</h5>
            <div className="space-y-4 mt-2 text-gray-700 dark:text-gray-300">
                <div>
